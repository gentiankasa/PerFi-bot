...
- In a terminal, navigate to `PerFi.VirtualAssistant`

    ```bash
    # change into project folder
    cd PerFi.VirtualAssistant
    ```
...
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `PerFi.VirtualAssistant` folder
  - Select `PerFi.VirtualAssistant.csproj` file
