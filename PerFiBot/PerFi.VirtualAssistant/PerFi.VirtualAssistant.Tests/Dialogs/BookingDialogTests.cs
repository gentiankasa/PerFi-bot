...
using PerFi.VirtualAssistant.Tests.Common;
using PerFi.VirtualAssistant.Tests.Dialogs.TestData;
...
using PerFi.VirtualAssistant;
using PerFi.VirtualAssistant.Dialogs;

namespace PerFi.VirtualAssistant.Tests.Dialogs
{
